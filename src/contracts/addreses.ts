...
const addresses: Record<GebDeployment, ContractList> = {
    'arbitrum-sepolia': {
        ...
        ETH_ORACLE_RELAYER: '0x0000000000000000000000000000000000000000',
    ...
    arbitrum: {
        ...
        ETH_ORACLE_RELAYER: '0x3e6C1621f674da311E57646007fBfAd857084383',
        ...
        PROXY_BASIC_ACTIONS: '0x688CFd8024ba60030fE4D669fd45D914A82933db',
...
const subgraphs: Record<GebDeployment, string> = {
    ...
    arbitrum: 'https://api.studio.thegraph.com/query/52770/open-dollar---mainnet/v1.8.0-rc.1',
