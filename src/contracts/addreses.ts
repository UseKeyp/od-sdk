...
export type ContractKey =
    ...
    | 'JOB_LIQUIDATION'
    | 'JOB_ORACLES'
    | 'CAMELOT_WSTETH_SILO_NITRO_POOL'
...
const addresses: Record<GebDeployment, ContractList> = {
    'arbitrum-sepolia': {
        ...
        CAMELOT_WSTETH_SILO_NITRO_POOL: '0x0000000000000000000000000000000000000000',
    },
    arbitrum: {
        PROXY_FACTORY: '0x0000000000000000000000000000000000000000',
        MULTICALL: '0xcA11bde05977b3631167028862bE2a173976CA11',
        ...
        CAMELOT_WSTETH_SILO_NITRO_POOL: '0xE430b35583385638411BcbcC198a8733434901Dc',
    },
    optimism: {
