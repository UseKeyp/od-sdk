...
const addresses: Record<GebDeployment, ContractList> = {
    'arbitrum-sepolia': {
        ...
        ETH_ORACLE: '0x0000000000000000000000000000000000000000',
    ...
    arbitrum: {
        ...
        ETH_ORACLE: '0x3e6C1621f674da311E57646007fBfAd857084383',
        ...
        PROXY_BASIC_ACTIONS: '0x9493767f055f6fca8e914205ce9e9a1c252323c0',
