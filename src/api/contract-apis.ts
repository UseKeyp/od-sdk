...
export class ContractApis {
    ...
    public ethOracleRelayer: types.IChainlinkRelayerChild
    ...
    constructor(
        ...
        this.ethOracleRelayer = types.IChainlinkRelayerChild__factory.connect(addressList.ETH_ORACLE_RELAYER, signerOrProvider)
